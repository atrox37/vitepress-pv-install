...
![index](.\docs\public\images\common\index.png)
...
## 通用界面结构以及功能说明
![1](.\docs\public\images\common\1.PNG)
整个用户界面首页主要分为三个部分：
...
- 左侧：侧边栏菜单
  - 用户可以点击想要跳转的功能模块页面进行跳转，其中**Devices**、**Alarm**、**Control**、**Statistic**都具有二级菜单。当前页面所对应的菜单会高亮。其菜单信息如下：
    ...
    - **Statistics**（统计）
      ...
      - **Operation Log**（操作日志）
      - **Running Log**（运行日志）
      <img src=".\docs\public\images\common\2.png" alt="2" style="zoom:50%;" />
  - 用户可以通过侧边栏右下角的缩放图标按钮，进行菜单栏的宽度缩放。
  |<img src=".\docs\public\images\common\3.png" alt="3" style="zoom:50%;" />|<img src=".\docs\public\images\common\4.png" alt="4" style="zoom:50%;" />|
  
- 右上方：顶部栏

  顶部右侧有“铃铛![5](.\docs\public\images\common\5.png)（Notice)”入口：
...
### Login 页面
![1](.\docs\public\images\login\1.png)
...
![1](.\docs\public\images\home\1.png)
...
<img src=".\docs\public\images\home\2.png" alt="2" style="zoom:50%;" />
- 第七部分为站点告警信息，展示当前的告警信息，从左向右依次为：
  - 告警设备
  - 告警等级（按照紧急度排序为：**L1>L2>L3**）
  |<img src=".\docs\public\images\home\3.png" alt="3" />|<img src=".\docs\public\images\home\4.png" alt="4" />|<img src=".\docs\public\images\home\5.png" alt="5" />|
  - 告警信息

### Devices 页面
![1](.\docs\public\images\Devices\pv\1.png)
...
![2](.\docs\public\images\Devices\pv\2.png)
...
![3](.\docs\public\images\Devices\pv\3.png)
...
#### Battery
##### Overview
![1](.\docs\public\images\Devices\battery\1.png)
该页面以卡片列表形式展示电池关键指标：
...
##### Value Monitoring
![2](.\docs\public\images\Devices\battery\2.png)
该页面包含 Tab：
...
##### Battery Management
![3](.\docs\public\images\Devices\battery\3.png)
...
#### Diesel Generator
##### Overvie
![1](.\docs\public\images\Devices\diesel\1.png)
顶部指标卡片：
